            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-600">Afli imobilele deținute de o persoană.</p>
                </div>
                <ArrowRight className="w-4 h-4 text-neutral-400 ml-auto flex-shrink-0 mt-1 group-hover:text-primary-600" />
              </Link>
              <Link
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-600">Atestă imobilele înscrise pe numele unei persoane.</p>
                </div>
                <ArrowRight className="w-4 h-4 text-neutral-400 ml-auto flex-shrink-0 mt-1 group-hover:text-primary-600" />
              </Link>
              <Link
