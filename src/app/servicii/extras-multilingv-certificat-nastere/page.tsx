...
export const metadata = buildPageMetadata({ title: TITLE, description: DESCRIPTION, path: PAGE_PATH, ogImage: '/og/services/certificat-nastere.png' });
  ...
  '@graph': [
    ...
    websiteNode(),
    {
      ...breadcrumbNode([
        ...
        { name: 'Extras Multilingv Certificat de Naștere', url: PAGE_URL },
      ]),
...
const FAQS = [
  { q: 'Ce este extrasul multilingv de pe certificatul de naștere?', a: 'Este un formular standard multilingv (introdus prin Regulamentul UE 2016/1191) care însoțește certificatul de naștere și redă datele în mai multe limbi oficiale ale UE. Rolul lui e să ajute la utilizarea documentului în alt stat membru, fără traducere.' },
  { q: 'Înlocuiește traducerea și apostila?', a: 'În interiorul Uniunii Europene, formularul standard multilingv elimină nevoia de traducere și de apostilă pentru certificatul de naștere. Pentru țări din afara UE rămâne necesară apostila de la Haga + traducerea legalizată.' },
  { q: 'Când am nevoie de el?', a: 'Când prezinți certificatul de naștere unei autorități dintr-un alt stat UE: căsătorie în străinătate, înscriere la școală, permis de ședere, angajare, dosare administrative.' },
  { q: 'De unde se obține?', a: 'De la serviciul de stare civilă al primăriei care deține actul de naștere, eliberat împreună cu certificatul/duplicatul. Prin eGhișeul.ro depunem cererea în numele tău și îți livrăm documentul, fără drum la ghișeu.' },
...
export default function ExtrasMultilingvNasterePage() {
  return (
    <>
        ...
        <header className="relative overflow-hidden bg-gradient-to-b from-secondary-900 to-[#0C1A2F] pt-24 lg:pt-36 pb-20 lg:pb-28">
          ...
          <div className="relative container mx-auto px-4 max-w-[820px]">
            <nav className="flex items-center gap-2 text-sm text-white/60 mb-6 flex-wrap" aria-label="Breadcrumb">
              ...
              <ChevronRight className="h-4 w-4" aria-hidden="true" />
              <span className="text-white/80">Extras Multilingv Certificat de Naștere</span>
            </nav>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Link
                href="/comanda/extras-multilingv-certificat-nastere/"
        ...
        <article className="py-12 lg:py-16 bg-white">
          <div className="container mx-auto px-4 max-w-[760px] prose prose-neutral max-w-none prose-headings:font-bold prose-headings:text-secondary-900 prose-h2:text-2xl prose-h2:mt-10 prose-h2:mb-4 prose-p:text-neutral-700 prose-li:text-neutral-700 prose-li:marker:text-primary-500 prose-a:text-primary-700 prose-a:font-medium prose-strong:text-secondary-900">
            ...
            <p>
              ...
              <strong> Regulamentul (UE) 2016/1191</strong>, care se atașează certificatului de naștere și redă
              datele în limbile oficiale ale statelor membre. Scopul lui este să ajute la folosirea actului într-un
              alt stat din Uniunea Europeană, eliminând nevoia de traducere.
            </p>

            <h2>Când îți trebuie</h2>
            <ul>
              <li>Căsătorie în străinătate (împreună cu <Link href="/servicii/eliberare-certificat-de-celibat/">dovada de celibat</Link>)</li>
              <li>Permis de ședere sau dosar de muncă într-o țară UE</li>
              <li>Înscrierea copilului la școală/grădiniță în străinătate</li>
              <li>Dosare administrative (alocații, asigurări, acte de identitate) în UE</li>
            </ul>
            ...
            <div className="not-prose my-8 rounded-2xl border border-primary-200 bg-primary-50/60 p-6">
              ...
              <ol className="mt-2 list-decimal space-y-1 pl-5 text-sm text-neutral-700">
                <li>Completezi formularul online (date personale + datele actului de naștere).</li>
            ...
            <p>
              ...
              traducere autorizată și de apostilă pentru certificatul de naștere folosit în alt stat UE. Pentru
            ...
            <p>
              ...
              deține actul de naștere, împreună cu certificatul sau cu un{' '}
              <Link href="/duplicat-certificat-de-nastere/">duplicat de certificat de naștere</Link>. Prin eGhișeul.ro
              depunem cererea în numele tău și îți livrăm documentul, fără drum la ghișeu.
            </p>
            ...
            <div className="not-prose rounded-2xl border border-primary-200 bg-primary-50/60 p-5 flex items-start gap-3 mt-6">
              ...
              <p className="text-sm text-secondary-800">
                ...
                <Link href="/servicii/eliberare-certificat-de-nastere/" className="font-semibold text-primary-700 underline">eliberare certificat de naștere</Link>{' '}
