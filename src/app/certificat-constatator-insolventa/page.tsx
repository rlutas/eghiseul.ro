...
export default function Page() {
  return (
      ...
      faqs={[
        {
          ...
          a: 'Un raport ONRC dedicat, care atestă negru pe alb dacă firma este sau nu înregistrată în procedurile prevăzute de legea insolvenței: insolvență, faliment, reorganizare judiciară, dizolvare, lichidare. E alt document decât certificatul constatator de bază, care doar menționează sumar starea firmei.',
        },
        {
    ...
    >
      ...
      <p>
        Concret, spune dacă firma este sau nu în procedură de insolvență, în faliment ori în
        reorganizare judiciară, și dacă are sau nu mențiuni de dizolvare sau lichidare.
      </p>
      <p>
      ...
      <p>
        ...
        diferența asta. Dacă ai dubii, cere-l pe cel dedicat, care atestă explicit ce vrea dosarul.
      </p>

      <h2>Unde se cere</h2>
      <p>
        Scopurile oficiale din formularul ONRC pentru acest raport sunt trei: licitație (cel mai
        frecvent; vezi și{' '}
        <Link href="/certificat-constatator-pentru-licitatie/">ghidul pentru licitații</Link>),
        birou notarial (<Link href="/certificat-constatator-pentru-notar/">detalii aici</Link>) și
        tribunal. Separat, e un instrument bun de verificare comercială: înainte
      ...
      <ol>
        <li>
          Intri pe{' '}
          <Link href="/comanda/certificat-constatator/?tip=insolventa">pagina de comandă</Link>, unde
        ...
        <li>
          Cererea intră la ONRC, iar certificatul vine pe email în maximum 24 de ore lucrătoare.
        </li>
      </ol>
      <p>
      ...
      <p>
        ...
        surse publice, gratuit, ca primă verificare. Dar dosarul de licitație nu se depune cu un
        screenshot: îți trebuie certificatul ONRC semnat electronic. Cele două nu se exclud:
        verifici gratuit întâi și comanzi documentul când ai nevoie de el la dosar.
      </p>
    </ArticleLayout>
  );
}
