      ...
      <main id="main-content" className="min-h-screen bg-neutral-50 -mt-16 lg:-mt-[112px]">
            ...
            <div className="flex flex-col-reverse lg:flex-row lg:justify-between gap-8 lg:gap-12">
              <div className="flex-1 max-w-[700px]">
                ...
                {/* Copia legalizată e OPȚIUNE (doar la cerere), nu serviciul de bază —
                    subtitlul promite exact serviciul: duplicatul (feedback Raul 01.09). */}
                <p className="text-lg sm:text-xl text-primary-500 font-semibold mb-5">
                  Duplicat Certificat de Căsătorie
                </p>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5 border border-white/20 mb-6">
                  <p className="text-white/90 leading-relaxed text-sm sm:text-base">
                    <strong className="text-primary-500">Certificatul de căsătorie</strong> — te ajutăm să-l obții
                    rapid de la Starea Civilă, fără drum la primărie:
                  </p>
          ...
          <div className="container mx-auto px-4 max-w-[1400px]">
            ...
            <div className="mt-16 lg:mt-20 max-w-[1100px] mx-auto">
              ...
              <p className="text-sm text-neutral-600 text-center mt-6 max-w-2xl mx-auto">
                ...
                ? Le poți comanda la fel de simplu. Ai nevoie de certificat pentru o autoritate din UE? Vezi{' '}
            ...
            <div className="grid lg:grid-cols-[5fr_6fr] gap-8 lg:gap-14 items-center">
              ...
              <div className="relative">
                ...
                <div className="relative bg-white rounded-2xl p-3 ring-1 ring-neutral-200 shadow-[0_20px_50px_rgba(6,16,31,0.16)]">
                  <Image
                    src="/images/specimens/certificat-casatorie.webp"
        ...
        <ServiceFAQ
          ...
          faqs={[
            ...
            { q: 'Primesc originalul sau o copie legalizată?', a: 'Duplicatul certificatului de căsătorie este un document fizic oficial. Îți trimitem confirmarea și o copie pe email, iar originalul / copia legalizată ajunge la tine prin curier în zile lucrătoare.' },
