                  ...
                  <div className="text-sm leading-relaxed">
                    ...
                    {emailTypoSuggestion ? (
                      <p className="mt-1 font-medium text-red-700">
                        ...
                        <a href={`mailto:${brand.contactEmail}`} className="underline">{brand.contactEmail}</a> sau la{' '}
                      ...
                      <p className="mt-1 text-neutral-500">
                        ...
                        <a href={`mailto:${brand.contactEmail}`} className="underline">{brand.contactEmail}</a> și o corectăm imediat.
                      </p>
                    )}
                  </div>
                </div>
