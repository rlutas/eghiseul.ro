...
const TITLE = 'Certificat constatator de bază: preț, ce conține, cum îl obții în minute';
const DESCRIPTION =
  ...
  return (
    <ArticleLayout
      ...
      faqs={[
        ...
        },
        {
          ...
          a: 'Legea nu îi dă un termen de valabilitate, dar instituțiile care îl cer (bănci, notari, autorități de licitație) acceptă de obicei un certificat de maximum 30 de zile de la emitere. Unele cer chiar mai recent, de exemplu 15 zile, așa că verifică cerința exactă a instituției.',
        },
        {
    ...
    >
      <p>
        ...
        lei prin portalul ONRC (cu cont). Prin eGhișeul costă 89 de lei cu tot cu taxe și se
        eliberează automat în câteva minute, doar cu CUI-ul firmei, la orice oră.
      </p>
      ...
      <p>
        Documentul emis de ONRC cuprinde situația la zi a firmei. Începe cu datele de
        identificare: denumirea, CUI-ul, numărul de ordine în Registrul Comerțului (J, F sau C),
        forma juridică, sediul social și durata societății. Urmează capitalul social subscris și
        vărsat, apoi asociații sau acționarii cu cotele lor de participare și administratorii cu
        puterile care le-au fost date.
      </p>
      <p>
        Mai găsești obiectul de activitate, adică activitatea principală și cele secundare cu
        codurile CAEN, sediile secundare și punctele de lucru, iar la final starea firmei: în
        funcțiune, dizolvare, lichidare, radiere sau mențiunea sumară de insolvență.
      </p>
      <p>
      ...
      <p>
        ...
        iar el apare pe certificat așa cum îl cere instituția.
      </p>
      <p>
        ...
        dizolvare. Datele Registrului Comerțului sunt publice, deci poți cere certificatul pentru
        orice firmă, nu doar pentru a ta.
      </p>

      <h2>30 de lei la ONRC vs. 89 de lei aici: comparația onestă</h2>
      <p>
        Direct la ONRC plătești 30 de lei (Ordinul MJ 380/C/2024), prin portal.onrc.ro sau
        InfoCert. Îți trebuie cont pe portal, iar drumul prin meniuri nu e scurt. Dacă ai timp și
        cont, e varianta cea mai ieftină.
      </p>
      <p>
        Prin eGhișeul plătești 89 de lei cu tot cu taxa ONRC, fără cont și fără navigat prin
      ...
      <ol>
        <li>
          ...
          unde tipul „de bază” e deja selectat;
        </li>
        <li>Completezi CUI-ul firmei, iar datele se verifică automat în baza ANAF;</li>
