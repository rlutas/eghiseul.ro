  ...
  return (
    <ArticleLayout
      ...
      faqs={[
        ...
        },
        {
          ...
          a: 'La ONRC, formele fără personalitate juridică (PFA, II, IF) sunt evidențiate pe persoana titularului, așa că raportul se generează după CNP. CUI-ul PFA-ului nu e suficient pentru acest tip de certificat, pentru că sistemul ONRC îl cere pe titular.',
        },
        {
    ...
    >
      <p>
        ...
        ci certificatul constatator pe persoană fizică, eliberat pe CNP-ul
      ...
      <p>
        ...
        generează după CNP-ul titularului și adună tot ce e înregistrat pe acea
      ...
      <p>
        Primul plan: înregistrările ca titular de PFA, II sau IF, cu denumirea, codul unic de
        înregistrare, numărul F… din Registrul Comerțului, sediul profesional, activitățile
        autorizate (coduri CAEN) și starea curentă, adică în funcțiune, suspendare sau radiere.
        Al doilea plan: calitățile în firme, dacă persoana e asociat, acționar sau administrator
        în societăți înregistrate la ONRC.
      </p>
      <p>
      ...
      <ol>
        <li>
          Deschizi <Link href="/comanda/certificat-constatator/?tip=pf">pagina de comandă</Link>, unde
