...
export const DOCUMENTERO_SITEMAP: DocumenteroSitemapEntry[] = [
  ...
  { path: '/certificat-de-nastere/', lastModified: '2026-09-19', changeFrequency: 'monthly', priority: 0.9 },
  { path: '/certificat-de-casatorie/', lastModified: '2026-09-19', changeFrequency: 'monthly', priority: 0.9 },
  { path: '/certificat-de-celibat/', lastModified: '2026-09-19', changeFrequency: 'monthly', priority: 0.9 },
