...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-secondary-900 to-[#0C1A2F]">
      {/* Background pattern */}
      ...
      <div className="relative container mx-auto px-4 max-w-[1100px] pt-28 pb-16 lg:pt-36 lg:pb-24">
        <div className="flex flex-wrap items-center justify-center gap-12 lg:gap-16">
          {/* Left Column - Text */}
          <div className="flex-1 min-w-[340px] max-w-[600px] text-center lg:text-left">
            ...
            {/* USP Highlight Box */}
            <div className="mt-6 bg-primary-500/10 border-l-[3px] border-primary-500 rounded-r-xl px-5 py-4">
            ...
            <div className="mt-8 inline-flex items-center gap-3 bg-white rounded-full px-6 py-3 shadow-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold text-secondary-900">Google Reviews</span>
              </div>
              ...
              <span className="text-xs text-neutral-500">• 391 recenzii</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-7 w-full max-w-md shadow-2xl">
            ...
            <div className="grid grid-cols-2 gap-2.5 mb-5">
              {services.map((service) => (
                <Link
                  ...
                  className="group relative flex items-center gap-2.5 p-3 bg-neutral-50 rounded-xl border border-transparent hover:border-primary-500 hover:bg-white hover:shadow-md transition-all"
                >
                  {service.badge && (
                    <span
                      className={`absolute top-1/2 right-2 -translate-y-1/2 text-[8px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wide ${
                  ...
                  <span className="text-xs font-semibold text-secondary-900 leading-tight group-hover:text-secondary-900">
                    {service.name}
                  </span>
                </Link>
              ))}
            ...
            <Button
              asChild
              className="w-full bg-primary-500 hover:bg-primary-600 text-secondary-900 font-bold h-12 rounded-xl shadow-md hover:shadow-lg transition-all mb-4"
            >
              <Link href="/#servicii">
                Toate Serviciile
            ...
            <div className="flex justify-center gap-6 pt-4 border-t border-neutral-200">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[11px] text-neutral-600 font-medium">Livrare 24-48h</span>
              </div>
              <div className="flex items-center gap-1.5">
                <Monitor className="w-4 h-4 text-primary-500" />
                <span className="text-[11px] text-neutral-600 font-medium">100% Online</span>
              </div>
              <div className="flex items-center gap-1.5">
                <Users className="w-4 h-4 text-primary-500" />
                <span className="text-[11px] text-neutral-600 font-medium">150k+ Clienți</span>
              </div>
            </div>
          </div>
        </div>
