...
> **Documentatia detaliata este in `docs/`.** Acest fisier este un ghid concis cu referinte. NU duplica informatii din docs aici. Regulile de cod, DB si documentatie sunt in `.Codex/rules/`.
...
### Database Operations
Vezi `.Codex/rules/database.md` pentru reguli detaliate. Ghid complet: `docs/deployment/DATABASE_MIGRATIONS.md`
