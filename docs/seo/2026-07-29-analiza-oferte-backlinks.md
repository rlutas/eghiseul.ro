# Analiza ofertelor de advertoriale (Comunicatedepresa.ro / Cristina Mihai)

**Data:** 2026-07-29 · **Stare:** de decis de Raul

Două oferte primite prin e-mail, ambele cu bonus un comunicat de presă Premium pe
Comunicatedepresa.ro.

## Ofertele, față în față

| # | Site | Tip | Preț | Oferta 5147 | Oferta 5148 |
|---|---|---|---|---|---|
| 1 | click.ro | Articol SEO | 130 € | ✅ | ✅ |
| 2 | libertatea.ro | Advertorial | 150 € | ✅ | ✅ |
| 3 | antena3.ro | Articol SEO | 99 € | ✅ | ✅ |
| 4 | prosport.ro | Articol SEO | 150 € | ✅ | ✅ |
| 5 | romaniatv.net | Advertorial | 200 € | ✅ | — |
| 6 | stiripesurse.ro | Advertorial | 249 € | ✅ | — |
| 7 | ziare.com | Advertorial | 200 € | — | ✅ |
| 8 | adevarul.ro | Advertorial secțiune relevantă | 400 € | — | ✅ |
| 9 | money.ro | Advertorial | 90 € | — | ✅ |
| | **Total brut** | | | 978 € | 1.219 € |
| | **Discount** | | | 10% | 22% |
| | **Total final** | | | **880,20 €** | **955,00 €** |

Diferență: **+74,80 €** pentru 5148. Valabilitate: 5147 expiră **31.07** (3 zile),
5148 pe **28.08**.

## ⚠️ Avem deja linkuri pe două dintre domeniile ofertate

Verificat în SERP (29 iul):

| Domeniu | Ce avem deja |
|---|---|
| **antena3.ro** | **2 advertoriale**, ambele în secțiunea `/continut-platit/`: [„platformă digitală inovatoare"](https://www.antena3.ro/continut-platit/eghiseul-ro-o-platforma-digitala-inovatoare-pentru-accesul-la-servicii-publice-730482.html), [„Revoluționăm accesul la serviciile publice"](https://www.antena3.ro/continut-platit/eghiseul-revolutionam-accesul-in-era-digitala-698713.html) |
| **ziare.com** | **3 advertoriale**: [eGhiseul – transformarea digitală](https://ziare.com/ghiseu/eghiseul-transformarea-digitala-a-serviciilor-publice-1853301), [Cazier Online (CJO)](https://ziare.com/cazier/cazier-online-inovatie-in-serviciile-publice-pentru-era-digitala-1860336), [extras de carte funciară](https://ziare.com/carte-funciara/cum-sa-obtii-un-extras-de-carte-funciara-de-pe-eghiseul-ro-1922279) |

**Consecință directă:** al doilea (al treilea, al patrulea) link de pe același domeniu
referitor valorează mult mai puțin decât primul — Google contorizează în primul rând
**domenii referitoare unice**, nu linkuri. Deci:

- din oferta **5147**: 99 € (antena3) merg pe un domeniu pe care îl avem deja
- din oferta **5148**: 299 € (antena3 99 + ziare.com 200) merg pe domenii deja
  acoperite — adică **aproape o treime din preț**

Merită cerut Cristinei **înlocuirea acestor poziții** cu domenii noi, la același preț.
Argumentul e verificabil, deci negocierea e ușoară.

## Relevanță tematică — unde chiar contează

Google evaluează un link și după cât de aproape e subiectul paginii-sursă de al
nostru. Ordonat după utilitate reală pentru noi:

| Domeniu | Relevanță pentru documente/juridic | Observație |
|---|---|---|
| **adevarul.ro** (secțiune relevantă) | 🟢 mare | Singura poziție din ofertă care promite explicit *secțiune relevantă* — de aceea și costă 400 €. Cea mai valoroasă din tot pachetul. |
| **money.ro** | 🟢 mare | Financiar/administrativ; foarte bun raport la 90 €. Cristina spune că direct de pe site e 75 €. |
| **ziare.com** | 🟡 medie | Are deja secțiuni `/cazier/`, `/carte-funciara/` — dar **îl avem deja de 3 ori**. |
| **libertatea.ro**, **click.ro** | 🟡 medie-mică | Tabloid, trafic uriaș, relevanță tematică slabă. Valoare mai mult de brand decât de SEO. |
| **antena3.ro** | 🟡 medie-mică | Deja avem 2; în plus, e în `/continut-platit/`, secțiune pe care Google o poate trata separat. |
| **romaniatv.net**, **stiripesurse.ro** | 🟠 mică | Știri generaliste; stiripesurse la 249 € e cea mai slabă valoare din listă. |
| **prosport.ro** | 🔴 nulă | **Sport.** Un link către un serviciu de caziere dintr-un articol de fotbal nu are logică editorială. 150 € prost cheltuiți. |

## Riscul de care trebuie ținut cont

Planul nostru SEO din 21 iulie spune explicit: *„NU cumpărăm pachete de link-uri /
PBN — risc pe un site cu istoric Ads sensibil"* (`docs/plans/2026-07-21-seo-plan-servicii-date-reale.md`, §6).

Ofertele **nu sunt PBN** — sunt publicații reale, cu trafic real, deci riscul e mult
mai mic. Dar rămân **linkuri plătite**, iar regula Google e ca acestea să fie marcate
`rel="sponsored"` sau `nofollow`. Dacă sunt marcate corect, nu transmit autoritate
directă (valoarea rămâne: trafic de referral, brand, semnal de menționare pentru AI).
Dacă sunt dofollow nemarcate, transmit autoritate, dar sunt tehnic încălcare.

**De întrebat Cristina, în scris, înainte de plată:** linkurile sunt `dofollow`?
Articolele rămân publicate permanent? Apar în secțiuni indexabile (nu `/continut-platit/`
sau similar, exclus din indexare)? Răspunsul schimbă complet valoarea pachetului.

## Ce ar trebui să promovăm — pe ce servicii

Din analiza pe date reale (GSC, 21 iul), paginile care aduc bani și au nevoie de
autoritate, în ordine:

1. **Extras carte funciară** — top seller, era pe poziția 12,8 (pagina 2). Cel mai
   mare upside din tot portofoliul. Avem deja un advertorial pe ziare.com fix pe tema
   asta — de continuat pe alte domenii.
2. **Certificat constatator (ONRC)** — poziția 12,1, la fel, „aproape de pagina 1".
3. **Certificat de urbanism** — 780 lei/comandă, SERP slab, pagină nouă.
4. **Cazier judiciar** — CTR 1,1%, concurență mare; aici ajută și
   `cazierjudiciaronline.com` (are deja link pe ziare.com).

**Recomandare de repartizare a linkurilor:** nu toate pe homepage. Cele mai valoroase
poziții (adevarul.ro, money.ro) merită direcționate spre **extras carte funciară** și
**certificat constatator**, nu spre pagina principală — acolo e diferența dintre
poziția 12 și pagina 1.

## Pe ce domeniu le punem

- **eghiseul.ro** — ținta principală: are portofoliul complet de servicii și cel mai
  mare upside (CF, constatator, urbanism).
- **cazierjudiciaronline.com** — merită 1-2 linkuri separate, pe cazier judiciar;
  are deja unul pe ziare.com. E domeniu diferit, deci autoritatea NU se transferă între
  ele — fiecare are nevoie de profil propriu.
- **ecazier.ro** — de lăsat deocamdată; are cel mai mic volum, iar bugetul e limitat.

## Recomandarea mea

**Oferta 5148, dar renegociată.** Motive:

- discount 22% vs 10%, iar diferența de preț e mică (75 €)
- conține cele două poziții cu adevărat relevante tematic (adevarul.ro, money.ro)
- scapă de stiripesurse.ro (249 €, valoare slabă) și romaniatv.net
- valabilitate până pe 28.08, deci timp de gândire — 5147 expiră în 3 zile

**Ce cer înainte să accept:**
1. **Înlocuirea antena3.ro și ziare.com** (299 €) cu domenii pe care nu le avem —
   argument: avem deja 2, respectiv 3 advertoriale acolo.
2. **Înlocuirea prosport.ro** (150 €) — sport, fără nicio legătură tematică.
3. **money.ro cumpărat direct** la 75 €, cum a spus chiar ea (economie 15 €).
4. Confirmare în scris: dofollow/sponsored, permanență, secțiune indexabilă.

Dacă acceptă înlocuirile, pachetul devine ~5-6 domenii **noi**, dintre care cel puțin
...
- **Profilul complet de backlinkuri** — nu avem chei Moz/Ahrefs (confirmat și în
  auditul din 28 iul). Verificarea de mai sus e prin SERP, deci acoperă doar ce e
  indexat și găsibil. Raportul „Linkuri" din Google Search Console (interfața web, nu
  API) ar da lista completă a domeniilor referitoare — merită deschis înainte de
  decizie, ca să vedem dacă mai avem deja și click.ro/libertatea.ro.
- **Dacă linkurile existente sunt dofollow** — necesită inspectarea codului paginilor.
