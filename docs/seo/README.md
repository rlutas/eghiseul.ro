...
| Fișier | Rol |
|---|---|
| [`2026-09-09-accessibility-tree-ai-agents.md`](2026-09-09-accessibility-tree-ai-agents.md) | 🔵 **RESEARCH** — arborele de accesibilitate = cum citesc agenții AI (Playwright MCP, ChatGPT Atlas, Gemini Mariner) o pagină; audit axe-core + ariaSnapshot pe 13 pagini: arbore CURAT cu JS activ, dar conținutul real stă în `<div hidden>` (Suspense `loading.tsx`) până rulează JS — invizibil pentru GPTBot/ClaudeBot/PerplexityBot (fetch-only, NU execută JS, deși `robots.txt` îi invită explicit). Nu afectează rankingul Google (nu e factor direct, Google randează JS) — afectează GEO. + bug verificat: skip-link mort pe `/`, `/servicii/`, `/comanda/status/` |
| [`2026-09-recuperare-spam-update/`](2026-09-recuperare-spam-update/README.md) | 🔴 **PLANUL CURENT** — recuperarea după August 2026 Spam Update: diagnostic (nu e AI, nu-s backlinkurile, nu-s paginile de locație ca formulă — e **clusterul comercial din template, la scară** + coeziune internă 7× mai slabă decât CJO), plan pe 6 faze, deciziile ownerului D1–D6. Start: [`PLAN-RECUPERARE.md`](2026-09-recuperare-spam-update/PLAN-RECUPERARE.md) |
| [`2026-09-recuperare-spam-update/research/09-lista-decizii-per-pagina.md`](2026-09-recuperare-spam-update/research/09-lista-decizii-per-pagina.md) | 🔴 **CURENT** — lista de decizii **per URL** (KEEP / KEEP + FIX / REWRITE / CONSOLIDATE / DELETE) pe toate cele **191 de pagini indexabile**, cu regula de decizie declarată înainte și aplicată mecanic pe joinul crawl (Screaming Frog 09.09) × GSC (3 luni + ferestre egale pre/post). Rezultat: **93 de pagini ies din index pentru 0,23% din clicuri**, zero ștergeri hard (toate 301), calculatoarele neatinse. Include secțiunea „cazuri de judecat de om" și decizia pe cele două seturi de locație (48 cazier oraș + 42 CF județ). Tabelul complet, cu toate coloanele, în `research/data/decizii-per-pagina.csv` |
| [`2026-09-recuperare-spam-update/research/05-inventar-si-footprint-site.md`](2026-09-recuperare-spam-update/research/05-inventar-si-footprint-site.md) | 🔴 **CURENT** — inventar & footprint MĂSURAT pe HTML-ul prerandat (build 07.09): 231 de pagini publice (nu 191 — sitemap-ul omite 40 de pagini de oraș `noindex` care sunt totuși live), 46 sub 800 de cuvinte; **95,7% din site publicat în 13 zile, 92 de pagini pe 22.06**; Jaccard median 0,66 (cazier oraș) / 0,56 (CF județ), iar **după mascarea numelor proprii crește la 0,72 / 0,71** = doorway; 43% din pagina de județ CF e text identic pe toate 42; cea mai duplicată pereche e extras multilingv naștere↔căsătorie (0,751); schema cu 3 `reviewCount` diferite + un `Person` care e un departament; disclaimerul de intermediar e pe 243/243 pagini de conținut **dar lipsește de pe wizard/checkout/success**. Date brute re-verificabile în `research/data/` |
| [`2026-08-24-spam-update-prabusire-organica.md`](2026-08-24-spam-update-prabusire-organica.md) | 🔴 **INCIDENT MAJOR** — August 2026 Spam Update (18–21.08) a anihilat vizibilitatea pe TOATE interogările de servicii/documente (clicuri 3.500/zi→~0, comenzi 38/zi→0); au supraviețuit doar calculatoarele + brandul. NU-s backlinkurile (Google: update-ul nu vizează link spam), NU paginile de județ (CJO le are mai identice și e neafectat) — profilul lovit = conținut la scară: 58 articole publicate în loturi, densitate dublă de tipare AI vs CJO (audit complet în doc, cu top pagini de rescris). Recovery = luni; recrawl nu ajută înainte de rescriere |
