...
> **⚠️ UPDATE 15.07 seara (secțiunea 7):** Raul a RESPINS fluxul comenzilor telefonice („nu e bine deloc, trebuie regândit tot logic") — se regândește pe 16.07. Codul rămâne livrat (nu strică nimic existent) dar NU se folosește. Întrebările deschise + ce e refolosibil: [docs/admin/comenzi-telefonice/](../admin/comenzi-telefonice/README.md).
