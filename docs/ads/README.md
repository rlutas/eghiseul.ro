...
| [2026-09-07-autorizare-guvernamentala-cai-si-contacte.md](2026-09-07-autorizare-guvernamentala-cai-si-contacte.md) | **cercetare**: există sau nu o cale de autorizare de la stat? Pe cazier/stare civilă/constatator NU există niciun mecanism; căi reale: distribuitor CNAIR (rovinietă), persoană juridică autorizată ANCPI (cadastru), abonament RECOM ONRC; de explorat: protocol ADR. Contacte complete + strategia cererilor pe Legea 544/2001 (răspunsul „nu există" = dovadă oficială pentru dosarul Google). Emailuri gata de trimis: [`2026-09-07-emailuri-institutii.txt`](2026-09-07-emailuri-institutii.txt) |
