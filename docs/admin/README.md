...
| [Plată prin transfer bancar (IBAN)](./plata-transfer-bancar.md) | Cum ajunge o comandă pe „Așteptare plată", ce primește clientul pe email și cum confirmă operatorul încasarea din extras (buton „Confirmă plata", referință obligatorie) | Implemented (2026-09-10) |
