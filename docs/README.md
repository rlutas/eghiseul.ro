...
- **Identificare imobil (după adresă / după proprietar): procesul complet confirmat cu topograful (25.09) — pasul 1 topograf, pasul 2 OCPI, acte de la client:** [`admin/identificare-imobil-nereusita.md`](admin/identificare-imobil-nereusita.md); PDF-ul vechi [`admin/identificare-imobil-ghid.pdf`](admin/identificare-imobil-ghid.pdf) e depășit (21.09); design: [`plans/2026-09-21-identificare-imobil-nereusita-design.md`](plans/2026-09-21-identificare-imobil-nereusita-design.md)
- **Mesaje pe comandă (echipă / topograf ↔ client):** [`admin/mesaje-client.md`](admin/mesaje-client.md); API: [`technical/api/orders-account-payment-proof-api.md`](technical/api/orders-account-payment-proof-api.md)
