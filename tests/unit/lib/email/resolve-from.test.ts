 ...
 * E-260919-HJ9X9). Default RESEND_VERIFIED_DOMAINS = eghiseul.ro.
 */
describe('resolveFrom', () => {
  ...
  it('falls back to the default sender for an unverified domain', () => {
    const from = resolveFrom('documentero.ro <contact@documentero.ro>');
    expect(from).not.toContain('documentero.ro');
